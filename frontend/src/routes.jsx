...
export const router = createBrowserRouter([
  ...
  { path: "/careers", Component: PublicJobListing },
  { path: "/careers/:id/apply", Component: PublicJobApplication },

  { path: "/admin/companies", Component: AdminCompanyRequests },
  { path: "/admin/companies/:id", Component: CompanyDetails },
  ...
  { path: "/employee/profile", Component: MyProfile },
  { path: "/employee/department", Component: MyDepartment },
  { path: "/employee/leave", Component: EmployeeLeaveManagement },
  { path: "/employee/performance", Component: EmployeePerformance },
  { path: "/employee/evaluation/:type/:id", Component: EmployeeEvaluationForm },
  { path: "/employee/performance/results/:id", Component: PerformanceResults },
  { path: "/employee/equipment", Component: Equipment },
  { path: "/employee/payslip/:id", Component: Payslip },
  { path: "/employee/notifications", Component: Notifications },
  ...
  { path: "/employees/import", Component: BulkImport },
  ...
  { path: "/performance/builder", Component: EvaluationBuilder },
  { path: "/performance/structure", Component: EvaluationStructure },
  { path: "/performance/results-table", Component: PerformanceResultsTable },
  { path: "/performance/create", Component: CreateEvaluationPeriod },
  { path: "/performance/assign-peers", Component: AssignPeerEvaluators },
  { path: "/performance/self-evaluation", Component: SelfEvaluation },
  { path: "/performance/peer-evaluation/:id", Component: PeerEvaluation },
  { path: "/performance/manager-evaluation", Component: ManagerEvaluation },
  { path: "/performance/results/:id", Component: PerformanceResults },

  { path: "/jobs", Component: JobVacancies },
  ...
  { path: "/payroll/generate", Component: PayrollGeneration },
  { path: "/payroll/import", Component: PayrollImport },
  { path: "/payroll/:id/review", Component: PayrollReview },
  { path: "/payroll/:id/approve", Component: PayrollApproval },
